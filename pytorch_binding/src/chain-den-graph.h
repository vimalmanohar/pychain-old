...
class DenominatorGraph {
 ...
 private:
  ...
  // The first column corresponds to the begin index.
  // The second column corresponds to the end index.
  at::Tensor backward_transition_indices_;
