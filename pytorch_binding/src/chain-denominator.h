...
#ifndef CHAIN_CHAIN_DENOMINATOR_H_
#define CHAIN_CHAIN_DENOMINATOR_H_
...
class DenominatorComputation {
 ...
 private:
  ...
  at::Tensor exp_nnet_output_transposed_;

  // the derivs w.r.t. the nnet outputs (transposed)
  at::Tensor nnet_output_deriv_transposed_;
  ...
  at::Tensor log_correction_term_;
...
#endif  // CHAIN_CHAIN_DENOMINATOR_H_
